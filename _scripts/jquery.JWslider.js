...
$.fn.JWslider = function(options){
	var defaults = {
					  ...
					  customblocksize:{
						  ...
						  stripefade:{ height:100,width:983 },
	...
	function stripefade(image)
	{
	    ...
	    timer = setInterval(function(){
				...
				arr[i++].animate({opacity:1},{duration: 300, easing:'easeOutSine'});
	...
	function effects()
	{
		 ...
		 if(bool==true)
		{
		 ...
		 case 0:stripefade(current.find("img"));break;
		 case 1:stripefade(current.find("img"));break;
		 case 2:stripefade(current.find("img"));break;
		 case 3:stripefade(current.find("img"));break;
		 case 4:stripefade(current.find("img"));break;
		 case 5:stripefade(current.find("img"));break;
		 }
	}
